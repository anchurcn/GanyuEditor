...
![GanyuDemo](docs/img/GanyuDemo.png)
## Feature
...
- [User Guide](docs/user-guide.md): background concepts and workflow for importing GoldSrc model bones, setting up ragdoll bodies/shapes/constraints, and exporting `.gpd` files.
